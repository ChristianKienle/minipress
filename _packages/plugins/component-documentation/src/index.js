...
module.exports = {
  async apply(minipress, options) {
    ...
    minipress.hooks.registerComponents.tapPromise(PLUGIN, async () => {
      ...
      minipress.components.register('ComponentApiMethods', join(__dirname, 'components', 'methods.vue'))
      minipress.components.register('ComponentApiMethod', join(__dirname, 'components', 'method.vue'))
    })
